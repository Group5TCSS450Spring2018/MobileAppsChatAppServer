...
router.post("/", (req, res) => {
    ...
    let query = `SELECT messages.message, messages.chatid, members.username, to_char(Messages.Timestamp AT TIME ZONE 'PDT', 'YYYY-MM-DD
                 HH24:MI:SS.US' ) AS Timestamp, chats.name FROM messages
